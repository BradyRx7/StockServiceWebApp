...
public class BasicStockServiceTest {
	 ...
	 */
	@Test
	public void testGetQuoteHalfDayDateRangeInterval() throws ParseException {
		StockService stockService = null;
		stockService = StockServiceFactory.getStockService();
		SimpleDateFormat dateFormat = new SimpleDateFormat("MM/dd/yyyy");
		Date from = dateFormat.parse("03/20/2020");
		Date until = dateFormat.parse("03/27/2020");
		IntervalEnum interval = IntervalEnum.HALF_DAY;
		SimpleDateFormat expectedDateFormat = new SimpleDateFormat("MM/dd/yyyy 'at' hha z");
		String expectedDate = "03/23/2020 at 12AM EDT";

		List<StockQuote> testQuoteRange = stockService.getQuote("UML", from, until, interval);
		assertEquals("Testing range of quotes failed - retrieval of 7th half day quote, " + expectedDate,
				testQuoteRange.get(6).getQuoteDate(), expectedDateFormat.parse(expectedDate));
	}
	...
	public void testGetQuoteDailyDateRangeInterval() throws ParseException {
		...
		SimpleDateFormat expectedDateFormat = new SimpleDateFormat("MM/dd/yyyy 'at' hha z");
		String expectedDate = "03/25/2020 at 12AM EDT";

		List<StockQuote> testQuoteRange = stockService.getQuote("UML", from, until, interval);
		assertEquals("Testing range of quotes failed - retrieval of 5th half day quote, " + expectedDate,
				testQuoteRange.get(5).getQuoteDate(), expectedDateFormat.parse(expectedDate));
	}
	 ...
	 */
	@Test
	public void testGetQuoteHourlyDateRangeInterval() throws ParseException {
		StockService stockService = null;
		stockService = StockServiceFactory.getStockService();
		SimpleDateFormat dateFormat = new SimpleDateFormat("MM/dd/yyyy");
		Date from = dateFormat.parse("03/20/2018");
		Date until = dateFormat.parse("3/22/2018");
		IntervalEnum interval = IntervalEnum.HOURLY;
		SimpleDateFormat expectedDateFormat = new SimpleDateFormat("MM/dd/yyyy 'at' hha z");
		String expectedDate = "03/21/2018 at 8AM EDT";

		List<StockQuote> testQuoteRange = stockService.getQuote("UML", from, until, interval);
		assertEquals("Testing range of quotes failed - retrieval of 32nd Hourly Quote, " + expectedDate,
				testQuoteRange.get(32).getQuoteDate(), expectedDateFormat.parse(expectedDate));
	}
