...
/**
 * ORM model for Person database table using JPA
 * Database holds user information for stock quotes app
 * 
 * (this is an exact copy of the class ORM example
 *  for a Person DAO class)
 *
 */
@Entity
@Table(name="person")
