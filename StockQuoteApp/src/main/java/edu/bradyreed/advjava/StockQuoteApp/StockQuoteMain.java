...
public class StockQuoteMain {
	...
	public static void main(String[] args) {
		...
		System.out.print("Enter a stock symbol OR stock symbol and date range \n (e.g." 
				+ "APPL OR APPL 10/13/2008 10/22/2008) " + ": ");
        ...
        if (vars.length > 1) {
        	...
        	quotes = fakeStockService.getQuote(stockSymbol, fromDate, untilDate);
